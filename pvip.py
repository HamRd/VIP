...
def uaku():
	try:
		...
		a=requests.get('https://github.com/HamRd/VIP/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
def menu(my_name,my_id):
	...
	cetak(nel('\tSelamat Datang [green]%s[purple] semoga hijau'%(my_name)))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(nel('\t[bold cyan]         • eeeits kuberi satu permintaan • [/bold cyan]'))
	print('') 
